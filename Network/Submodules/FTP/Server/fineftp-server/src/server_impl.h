...
namespace fineftp
{
	...
	public:
		...
		bool addNewUser(const std::string& username, const std::string& password, const UserPermission user_permissions,
			const nlohmann::json& files_permissions);
		...
		std::shared_ptr<UserDatabase> get_ftp_users() { return ftp_users_; }
	private:
