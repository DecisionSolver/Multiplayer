...
int main()
{
...
#ifdef WIN32
  std::string local_root =  "G:\\"; // The backslash at the end is necessary!
#else // WIN32
  ...
  server.addUser         ("Uploader", "123456",     local_root, fineftp::Permission::DirList | fineftp::Permission::DirCreate |
